...
class AppStrings {
  ...
  // Nearby locations
  String get findNearbyPlaces => isAr ? 'البحث عن الأماكن القريبة' : 'Trouver des lieux à proximité';
  String get nearbyPlaces => isAr ? 'الأماكن القريبة' : 'Lieux à proximité';
  String get allPlaces => isAr ? 'جميع الأماكن' : 'Tous les lieux';
  String get maxDistance => isAr ? 'المسافة القصوى' : 'Distance maximale';
  String get distance => isAr ? 'المسافة' : 'Distance';
  String get enableLocation => isAr ? 'تفعيل الموقع' : 'Activer la localisation';
  String get locationPermissionDenied => isAr ? 'تم رفض إذن الموقع' : 'Permission de localisation refusée';
  String get locationPermissionDeniedPermanently => isAr ? 'تم رفض إذن الموقع بشكل دائم. يرجى تفعيله من الإعدادات.' : 'Permission de localisation refusée définitivement. Veuillez l\'activer dans les paramètres.';
  String get locationServiceDisabled => isAr ? 'خدمة الموقع معطلة' : 'Service de localisation désactivé';
  String get gettingLocation => isAr ? 'جاري الحصول على الموقع...' : 'Obtention de votre position...';
  String get km => isAr ? 'كم' : 'km';
  String get meters => isAr ? 'م' : 'm';
}
