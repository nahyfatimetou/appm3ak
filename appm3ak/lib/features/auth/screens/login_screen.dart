      ...
      setState(() {
        ...
        if (e is DioException) {
          if (e.response != null) {
            ...
            errorMsg = 'Impossible de se connecter au serveur. Vérifiez que le backend est démarré sur http://localhost:3000';
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton(
                        ...
                        child: Row(
                          ...
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Icon(Icons.g_mobiledata, size: 24, color: primary),
                            const SizedBox(width: 8),
                            Flexible(
                              child: Text(
